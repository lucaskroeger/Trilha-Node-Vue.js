      ...
      <v-col cols="12" sm="8" md="6" lg="4">
        <v-card class="pa-8 auth-card" elevation="8">
          <div class="text-center mb-8">
            ...
            <h1 class="text-h3 font-weight-bold app-title">Criar Conta</h1>
            <p class="text-body-1 text-medium-emphasis mt-2">Registre-se no TechStore</p>
          </div>
...
export default {
  ...
  setup() {
    ...
    const rules = {
      ...
      minLength: v => v.length >= 6 || 'Senha deve ter pelo menos 6 caracteres',
      confirmPassword: v => v === formData.senha || 'Senhas não coincidem'
    }
